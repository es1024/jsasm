...
const tests = {
    ...
    'inst 05 - add eax, imm32': function (test) {
        ...
        ti(test, [0x05, 0x02, 0x00, 0x00, 0x80], { eax: 0x80000001 }, { eax: 0x00000003 }, '', 'cpo');
        ti(test, [0x05, 0x00, 0x00, 0x00, 0xD0], { eax: 0x30000000 }, { eax: 0x00000000 }, '', 'cpz');
    ...
    'inst 2A - sub r/8, rm8': function (test) {
        const txt = [0x2A, 0xC1];
    ...
    'inst 2D - sub eax, imm32': function (test) {
        ...
        ti(test, [0x2D, 0xAB, 0x41, 0x32, 0xAB], { eax: 0x66774711 }, { eax: 0xBB450566 }, '', 'cpas');
        ...
        ti(test, [0x2D, 0x30, 0xE7, 0x19, 0x24], { eax: 0x2419E730 }, { eax: 0x00000000 }, '', 'pz');
    ...
    'inst 3A - cmp r/8, rm8': function (test) {
        const txt = [0x3A, 0xC1];
    ...
    'inst 3D - cmp eax, imm32': function (test) {
        ...
        ti(test, [0x3D, 0xAB, 0x41, 0x32, 0xAB], { eax: 0x66774711 }, { eax: 0x66774711 }, '', 'cpas');
