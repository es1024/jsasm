...
const tests = {
    "inst 08 - or r/m8, r8": function (test) {
    ...
    "inst 09 - or r/m32, r32": function (test) {
    ...
    "inst 0A - or r8, r/m8": function (test) {
    ...
    "inst 0B - or r32, r/m32": function (test) {
    ...
    "inst 0C - or al, imm8": function (test) {
    ...
    "inst 0D - or eax, imm32": function (test) {
    ...
    "inst 20 - and r/m8, r8": function (test) {
    ...
    "inst 21 - and r/m32, r32": function (test) {
    ...
    "inst 22 - and r8, r/m8": function (test) {
    ...
    "inst 23 - and r32, r/m32": function (test) {
    ...
    "inst 24 - and al, imm8": function (test) {
    ...
    "inst 25 - and eax, imm32": function (test) {
    ...
    "inst 30 - xor r/m8, r8": function (test) {
    ...
    "inst 31 - xor r/m32, r32": function (test) {
    ...
    "inst 32 - xor r8, r/m8": function (test) {
    ...
    "inst 33 - xor r32, r/m32": function (test) {
    ...
    "inst 34 - xor al, imm8": function (test) {
    ...
    "inst 35 - xor r32, r/m32": function (test) {
...
//# sourceMappingURL=test_x86_bitwise.generated.js.map